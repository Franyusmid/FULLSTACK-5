...
// El hook useCart recibe tres argumentos: initialCart (el carrito inicial),
//  getCheckoutSession (una función para obtener la sesión de pago) y editCart (una función para editar el carrito).
